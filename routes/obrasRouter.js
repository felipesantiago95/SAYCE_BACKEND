...
router.get('/socios', verificarRol(['administrador', 'supervisor', 'operador']), async (req, res) => {
  try {
...
router.get('/socios/:id', verificarRol(['administrador', 'supervisor', 'operador']), async (req, res) => {
  try {
...
router.get('/:id', verificarRol(['administrador', 'supervisor']), async (req, res) => {
  try {
...
router.post('/', verificarRol(['administrador', 'supervisor']), async (req, res) => {
  try {
...
router.put('/:id', verificarRol(['administrador', 'supervisor']), async (req, res) => {
  try {
